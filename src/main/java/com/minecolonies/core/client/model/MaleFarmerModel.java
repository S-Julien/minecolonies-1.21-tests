...
public class MaleFarmerModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition strapLeft_r1 =
            seedBox.addOrReplaceChild("strapLeft_r1", CubeListBuilder.create().texOffs(64, 53).addBox(-0.9F, -2.6F, -9.1F, 0.0F, 1.0F, 10.0F, new CubeDeformation(0.11F))
        ...
        PartDefinition seeds_r1 =
            seedBox.addOrReplaceChild("seeds_r1",
                CubeListBuilder.create().texOffs(72, 49).addBox(-3.0F, -1.25F, -1.6667F, 6.0F, 1.0F, 3.0F, new CubeDeformation(-0.1F))
                    ...
                    .texOffs(71, 34).addBox(-3.0F, 0.45F, -1.6667F, 6.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-4.0F, 6.35F, -0.3333F, -0.0873F, 0.0F, 0.0F));
