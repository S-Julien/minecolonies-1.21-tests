...
public class FemaleShepherdModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition detail_r1 = LassCap.addOrReplaceChild("detail_r1",
            CubeListBuilder.create().texOffs(92, 52).addBox(-5.0F, -0.6F, -1.1F, 10.0F, 4.0F, 8.0F, new CubeDeformation(0.01F)),
        ...
        PartDefinition staff_r1 = staff.addOrReplaceChild("staff_r1",
            CubeListBuilder.create().texOffs(84, 0).addBox(-0.5F, -13.0F, -0.5F, 1.0F, 32.0F, 1.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0436F, 0.0F, 0.0F));

        PartDefinition shoulderArm =
            FoldedRightArm.addOrReplaceChild("shoulderArm", CubeListBuilder.create().texOffs(54, 16).addBox(-2.01F, -2.01F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition foreArm =
            FoldedRightArm.addOrReplaceChild("foreArm", CubeListBuilder.create().texOffs(68, 16).addBox(-1.01F, -1.5F, -2.5F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.01F))
