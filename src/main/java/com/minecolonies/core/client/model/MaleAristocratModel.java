    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition FancyHat =
            bipedHead.addOrReplaceChild("FancyHat",
                CubeListBuilder.create().texOffs(96, 0).addBox(-4.0F, -2.0525F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.7F))
                ...
                PartPose.offsetAndRotation(0.0F, -6.2375F, 0.0F, 0.0F, -0.0175F, -0.0436F));

        PartDefinition feather2_r1 = FancyHat.addOrReplaceChild("feather2_r1",
            CubeListBuilder.create().texOffs(92, 29).addBox(-1.3F, -5.9F, -1.9F, 0.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)),
