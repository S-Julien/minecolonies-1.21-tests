...
public class MaleCrafterModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition feather_r1 = bipedHead.addOrReplaceChild("feather_r1",
            CubeListBuilder.create().texOffs(56, 15).addBox(-2.3F, -1.9F, -8.6F, 0.0F, 6.0F, 9.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-4.0F, -10.5F, 4.5F, 0.0F, -0.2356F, 0.0F));

        PartDefinition Beard1 =
            bipedHead.addOrReplaceChild("Beard1", CubeListBuilder.create().texOffs(56, 0).addBox(-4.0F, -1.0F, 3.0F, 8.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition glasses =
            bipedHead.addOrReplaceChild("glasses", CubeListBuilder.create().texOffs(92, 0).addBox(-5.5F, -3.6F, -1.3F, 7.0F, 7.0F, 1.0F, new CubeDeformation(-2.0F))
        ...
        PartDefinition apronBody =
            bipedBody.addOrReplaceChild("apronBody", CubeListBuilder.create().texOffs(114, 43).addBox(-4.4F, -13.9F, -2.9F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.15F))
        ...
        PartDefinition map_r1 = bag.addOrReplaceChild("map_r1",
            CubeListBuilder.create().texOffs(60, 30).addBox(-2.8F, -3.2F, -6.5F, 6.0F, 6.0F, 13.0F, new CubeDeformation(-2.0F)),
        ...
        PartDefinition bipedRightArm =
            partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 16).addBox(-3.5F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition apronRightLeg = bipedRightLeg.addOrReplaceChild("apronRightLeg",
            CubeListBuilder.create().texOffs(114, 51).addBox(-4.25F, -11.5F, -2.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.25F)),
        ...
        PartDefinition apronLeftLeg = bipedLeftLeg.addOrReplaceChild("apronLeftLeg",
            CubeListBuilder.create().texOffs(106, 51).addBox(0.25F, -11.5F, -2.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.25F)),
            PartPose.offset(-1.9F, 12.0F, 0.0F));
