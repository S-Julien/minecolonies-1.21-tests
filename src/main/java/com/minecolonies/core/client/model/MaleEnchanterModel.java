...
public class MaleEnchanterModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition capeBody =
            Body.addOrReplaceChild("capeBody", CubeListBuilder.create().texOffs(102, 36).addBox(-4.0F, -5.2F, -2.5F, 8.0F, 2.0F, 5.0F, new CubeDeformation(0.21F))
        ...
        PartDefinition book1_r1 = bag.addOrReplaceChild("book1_r1",
            CubeListBuilder.create().texOffs(96, 8).mirror().addBox(-0.8F, -2.0F, -3.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(86, 4).mirror().addBox(-1.0F, 1.4F, -2.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(-5.8F, 9.5722F, 1.6111F, -1.6138F, 0.0076F, 0.1744F));

        PartDefinition strapback_r1 = bag.addOrReplaceChild("strapback_r1",
            CubeListBuilder.create().texOffs(122, 14).addBox(-0.5F, -14.3F, 0.0F, 1.0F, 15.0F, 0.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition strapfrontb_r1 = bag.addOrReplaceChild("strapfrontb_r1",
            CubeListBuilder.create().texOffs(123, 14).addBox(-0.5F, -1.8F, 0.3F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition strapfrontb_r2 = bag.addOrReplaceChild("strapfrontb_r2",
            CubeListBuilder.create().texOffs(123, 19).addBox(-0.5F, -2.5F, 0.5F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition strapfronta_r1 = bag.addOrReplaceChild("strapfronta_r1",
            CubeListBuilder.create().texOffs(126, 14).addBox(-0.5F, -8.0F, 0.0F, 1.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-5.5F, 9.4F, -4.1F, -0.0873F, 0.0F, 0.7854F));

        PartDefinition bag_r1 = bag.addOrReplaceChild("bag_r1",
            CubeListBuilder.create().texOffs(106, 0).addBox(-1.9F, -3.0F, -4.0F, 3.0F, 6.0F, 8.0F, new CubeDeformation(0.03F)),
        ...
        PartDefinition capeShoulderRight = Right_Arm.addOrReplaceChild("capeShoulderRight",
            CubeListBuilder.create().texOffs(110, 29).addBox(-2.4F, -1.0F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.2F)),
        ...
        PartDefinition capeShoulderLeft = Left_Arm.addOrReplaceChild("capeShoulderLeft",
            CubeListBuilder.create().texOffs(92, 29).addBox(-2.0F, -1.0F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.2F)),
            PartPose.offset(1.1F, -1.2F, 0.0F));
