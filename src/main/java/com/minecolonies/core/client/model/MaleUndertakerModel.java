...
public class MaleUndertakerModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition Hat =
            bipedHead.addOrReplaceChild("Hat",
                CubeListBuilder.create().texOffs(64, 0).addBox(-3.9664F, -3.1854F, -5.0F, 8.0F, 2.0F, 10.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition hatpartlowleft = Hat.addOrReplaceChild("hatpartlowleft",
            CubeListBuilder.create().texOffs(92, 7).addBox(-2.3F, -0.7F, -5.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.01F)),
            PartPose.offsetAndRotation(-3.1F, -2.2F, 0.0F, 0.0F, 0.0F, 0.48F));

        PartDefinition hatpartlowright = Hat.addOrReplaceChild("hatpartlowright",
            CubeListBuilder.create().texOffs(96, 19).addBox(0.4466F, 1.4993F, -5.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.01F)),
        ...
        PartDefinition bipedRightLeg = partDefinition.addOrReplaceChild("right_leg",
