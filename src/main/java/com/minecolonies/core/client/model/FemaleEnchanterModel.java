...
public class FemaleEnchanterModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition book2_r1 =
            bag.addOrReplaceChild("book2_r1",
                CubeListBuilder.create().texOffs(86, 4).mirror().addBox(-1.0F, 1.4F, -2.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
                    .texOffs(96, 8).mirror().addBox(-0.8F, -2.0F, -3.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
        ...
        PartDefinition capeShoulderRight = Right_Arm.addOrReplaceChild("capeShoulderRight",
            CubeListBuilder.create().texOffs(112, 29).addBox(-1.4F, -1.0F, -2.5F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.2F)),
        ...
        PartDefinition capeShoulderLeft = Left_Arm.addOrReplaceChild("capeShoulderLeft",
            CubeListBuilder.create().texOffs(96, 29).addBox(-2.0F, -1.0F, -2.5F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.2F)),
            PartPose.offset(1.1F, -1.2F, 0.0F));
