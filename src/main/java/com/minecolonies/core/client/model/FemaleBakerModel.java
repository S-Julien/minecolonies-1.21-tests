...
public class FemaleBakerModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition top_r1 = BakerHat.addOrReplaceChild("top_r1",
            CubeListBuilder.create().texOffs(86, 12).addBox(-6.4F, -1.1F, -6.2F, 11.0F, 2.0F, 10.0F, new CubeDeformation(0.1F)),
        ...
        PartDefinition middle_r1 = BakerHat.addOrReplaceChild("middle_r1",
            CubeListBuilder.create().texOffs(94, 24).addBox(-4.48F, -1.8F, -4.7F, 9.0F, 4.0F, 8.0F, new CubeDeformation(-0.1F)),
        ...
        PartDefinition base_r1 = BakerHat.addOrReplaceChild("base_r1",
            CubeListBuilder.create().texOffs(88, 0).addBox(-5.0F, -1.1F, -5.4F, 10.0F, 2.0F, 10.0F, new CubeDeformation(-0.2F)),
        ...
        PartDefinition apronBody =
            bipedBody.addOrReplaceChild("apronBody", CubeListBuilder.create().texOffs(114, 47).addBox(-4.4F, -13.9F, -2.9F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.15F))
        ...
        PartDefinition apronRightLeg = bipedRightLeg.addOrReplaceChild("apronRightLeg",
            CubeListBuilder.create().texOffs(114, 56).addBox(-4.25F, -11.5F, -2.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.25F)),
        ...
        PartDefinition apronLeftLeg = bipedLeftLeg.addOrReplaceChild("apronLeftLeg",
            CubeListBuilder.create().texOffs(106, 56).addBox(0.25F, -11.5F, -2.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.25F)),
            PartPose.offset(-1.9F, 12.0F, 0.0F));
