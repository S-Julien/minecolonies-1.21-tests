    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition FancyHat =
            bipedHead.addOrReplaceChild("FancyHat",
                CubeListBuilder.create().texOffs(96, 0).addBox(-4.0F, -1.9525F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.6F))
                    ...
                    .texOffs(102, 25).addBox(-5.0F, -0.3625F, 5.0F, 10.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -6.2375F, 0.0F, 0.0F, 0.0F, -0.0436F));

        PartDefinition feather2_r1 = FancyHat.addOrReplaceChild("feather2_r1",
            CubeListBuilder.create().texOffs(86, 23).addBox(-0.6F, -6.7F, -1.9F, 0.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition apronBody =
            bipedBody.addOrReplaceChild("apronBody", CubeListBuilder.create().texOffs(70, 27).addBox(-4.4F, -13.9F, -2.9F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.15F))
        ...
        PartDefinition apronRightLeg = bipedRightLeg.addOrReplaceChild("apronRightLeg",
            CubeListBuilder.create().texOffs(70, 35).addBox(-4.25F, -11.5F, -2.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.25F)),
        ...
        PartDefinition apronLeftLeg = bipedLeftLeg.addOrReplaceChild("apronLeftLeg",
            CubeListBuilder.create().texOffs(62, 35).addBox(0.25F, -11.5F, -2.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.25F)),
            PartPose.offset(-1.9F, 12.0F, 0.0F));
