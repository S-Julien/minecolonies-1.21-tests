...
public class FemaleCrafterModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition feather_r1 = bipedHead.addOrReplaceChild("feather_r1",
        ...
        PartDefinition glasses =
            bipedHead.addOrReplaceChild("glasses", CubeListBuilder.create().texOffs(74, 0).addBox(-5.5F, -3.6F, -1.3F, 7.0F, 7.0F, 1.0F, new CubeDeformation(-2.0F))
        ...
        PartDefinition apronBody =
            bipedBody.addOrReplaceChild("apronBody", CubeListBuilder.create().texOffs(114, 11).addBox(-4.4F, -13.9F, -2.9F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.15F))
        ...
        PartDefinition map_r1 = bag.addOrReplaceChild("map_r1",
            CubeListBuilder.create().texOffs(65, 27).addBox(-2.8F, -3.2F, -6.5F, 6.0F, 6.0F, 13.0F, new CubeDeformation(-2.0F)),
            PartPose.offsetAndRotation(-5.5F, 8.0F, 0.0F, 0.0F, 0.0F, 1.0472F));
        ...
        PartDefinition apronRightLeg = bipedRightLeg.addOrReplaceChild("apronRightLeg",
        ...
        PartDefinition apronLeftLeg = bipedLeftLeg.addOrReplaceChild("apronLeftLeg",
