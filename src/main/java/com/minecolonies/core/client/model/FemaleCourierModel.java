...
public class FemaleCourierModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition ponyTailTip_r1 = Ponytail.addOrReplaceChild("ponyTailTip_r1",
            CubeListBuilder.create().texOffs(88, 55).addBox(0.0F, 1.0F, -0.1F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.1F)),
            PartPose.offsetAndRotation(-0.5F, -1.502F, 3.1709F, 0.2231F, 0.0F, 0.0F));

        PartDefinition ponytailBase_r1 = Ponytail.addOrReplaceChild("ponytailBase_r1",
            CubeListBuilder.create().texOffs(86, 48).addBox(0.0F, 1.0F, -0.3F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-1.0F, -4.502F, 0.3709F, 0.5577F, 0.0F, 0.0F));

        PartDefinition bipedBody =
            partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, -11.35F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition backpack = bipedBody.addOrReplaceChild("backpack",
            CubeListBuilder.create().texOffs(100, 50).addBox(-4.0F, -1.7F, 0.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.3F)),
            PartPose.offset(0.0F, -6.9F, 2.3F));

        PartDefinition lid_r1 = backpack.addOrReplaceChild("lid_r1",
            CubeListBuilder.create().texOffs(100, 42).addBox(-4.0F, -1.2F, -0.5F, 8.0F, 2.0F, 6.0F, new CubeDeformation(0.4F)),
            PartPose.offsetAndRotation(0.0F, -2.1F, 0.6F, 0.0436F, 0.0F, 0.0F));

        PartDefinition breast =
            bipedBody.addOrReplaceChild("breast",
                CubeListBuilder.create().texOffs(64, 49).addBox(-3.0F, 2.2938F, -5.716F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
                    .texOffs(64, 55).addBox(-3.0F, 2.2938F, -5.716F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.25F)),
                PartPose.offsetAndRotation(-1.0F, -9.0F, 4.0F, -0.5236F, 0.0F, 0.0F));

        PartDefinition bipedRightArm =
            partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 16).addBox(-2.0F, -1.8F, -2.3F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition bipedLeftArm =
            partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(32, 48).addBox(-1.0F, -1.8F, -2.3F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
