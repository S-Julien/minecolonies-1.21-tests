...
public class FemaleChickenHerderModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition ribbonC_r1 = Hat.addOrReplaceChild("ribbonC_r1",
            CubeListBuilder.create().texOffs(58, 32).addBox(0.0F, 0.0F, -2.5F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-1.5F, -3.0F, -2.5F, 0.0F, 0.5236F, 0.0F));

        PartDefinition ribbonB_r1 = Hat.addOrReplaceChild("ribbonB_r1",
            CubeListBuilder.create().texOffs(58, 29).addBox(-2.0F, 0.0F, -2.5F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(1.5F, -3.0F, -2.5F, 0.0F, -0.5236F, 0.0F));

        PartDefinition ribbonA_r1 = Hat.addOrReplaceChild("ribbonA_r1",
            CubeListBuilder.create().texOffs(58, 26).addBox(-2.5F, -2.9F, 0.0F, 5.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, -3.1F, -3.0F, -0.2618F, 0.0F, 0.0F));

        PartDefinition strapLeftTop_r1 = Hat.addOrReplaceChild("strapLeftTop_r1",
            CubeListBuilder.create().texOffs(76, 29).addBox(0.0F, -4.9575F, -0.5F, 0.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(6.0709F, 0.4F, -2.5F, 0.0F, 0.0F, -0.8116F));

        PartDefinition strapRightTop_r1 = Hat.addOrReplaceChild("strapRightTop_r1",
            CubeListBuilder.create().texOffs(78, 29).addBox(0.0F, -4.9837F, -0.5F, 0.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-6.0742F, 0.4F, -2.5F, 0.0F, 0.0F, 0.8116F));

        PartDefinition strapRight_r1 = Hat.addOrReplaceChild("strapRight_r1",
            CubeListBuilder.create().texOffs(82, 26).mirror().addBox(-0.05F, -0.1F, -0.5F, 0.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(-6.0F, 0.5F, -2.5F, 0.0F, 0.0F, -0.2618F));

        PartDefinition strapLeft_r1 = Hat.addOrReplaceChild("strapLeft_r1",
            CubeListBuilder.create().texOffs(80, 26).addBox(0.15F, -0.1F, -0.5F, 0.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(5.9F, 0.5F, -2.5F, 0.0F, 0.0F, 0.2635F));

        PartDefinition bottomRight_r1 = Hat.addOrReplaceChild("bottomRight_r1",
            CubeListBuilder.create().texOffs(74, 25).addBox(-0.5F, -2.0F, -5.5F, 3.0F, 1.0F, 10.0F, new CubeDeformation(0.1F)),
            PartPose.offsetAndRotation(-4.2419F, 1.6799F, -0.5F, 0.0F, 0.0F, -0.6981F));

        PartDefinition bottomLeft_r1 = Hat.addOrReplaceChild("bottomLeft_r1",
            CubeListBuilder.create().texOffs(58, 26).addBox(-2.5F, -2.0F, -5.5F, 3.0F, 1.0F, 10.0F, new CubeDeformation(0.1F)),
            PartPose.offsetAndRotation(4.2419F, 1.6799F, -0.5F, 0.0F, 0.0F, 0.6981F));
        ...
        PartDefinition strapfrontb_r2 = seedsBag.addOrReplaceChild("strapfrontb_r2",
            CubeListBuilder.create().texOffs(123, 55).addBox(-0.5F, -2.5F, 0.5F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition strapfronta_r1 = seedsBag.addOrReplaceChild("strapfronta_r1",
            CubeListBuilder.create().texOffs(126, 50).addBox(-0.5F, -8.0F, 0.0F, 1.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)),
