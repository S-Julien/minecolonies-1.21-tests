...
public class FemaleStudentModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition hairback1_r1 =
            Head.addOrReplaceChild("hairback1_r1", CubeListBuilder.create().texOffs(74, 0).addBox(-2.0F, -2.0F, -1.9F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition Book = Right_Arm.addOrReplaceChild("book",
            CubeListBuilder.create().texOffs(64, 37).mirror().addBox(-7.3F, -14.5F, -3.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(-0.2F)).mirror(false),
            PartPose.offset(5.6F, 22.0F, 0.0F));
        ...
        PartDefinition rightShoulder =
            Right_Arm_Folded.addOrReplaceChild("rightShoulder", CubeListBuilder.create().texOffs(56, 16).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition rightForeArm =
            Right_Arm_Folded.addOrReplaceChild("rightForeArm", CubeListBuilder.create().texOffs(88, 16).addBox(-1.01F, -0.6F, -2.3F, 7.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
