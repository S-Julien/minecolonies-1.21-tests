...
public class MaleMechanistModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition glassesOff =
            bipedHead.addOrReplaceChild("glassesOff", CubeListBuilder.create().texOffs(98, 16).addBox(-4.0F, -4.0F, -4.01F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.05F))
        ...
        PartDefinition crystalLeft2 =
            glassesOff.addOrReplaceChild("crystalLeft2", CubeListBuilder.create().texOffs(111, 12).addBox(-3.0F, -6.0F, -4.8F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.2F))
        ...
        PartDefinition crystalRight2 =
            glassesOff.addOrReplaceChild("crystalRight2", CubeListBuilder.create().texOffs(91, 12).addBox(-3.0F, -6.0F, -4.8F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.2F))
        ...
        PartDefinition glassesOn =
            bipedHead.addOrReplaceChild("glassesOn", CubeListBuilder.create().texOffs(98, 6).addBox(-4.0F, -4.0F, -4.01F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.05F))
        ...
        PartDefinition crystalLeft =
            glassesOn.addOrReplaceChild("crystalLeft", CubeListBuilder.create().texOffs(111, 2).addBox(-3.0F, -6.0F, -4.8F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.2F))
        ...
        PartDefinition crystalRight =
            glassesOn.addOrReplaceChild("crystalRight", CubeListBuilder.create().texOffs(91, 2).addBox(-3.0F, -6.0F, -4.8F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.2F))
