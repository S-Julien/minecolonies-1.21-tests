...
public class FemaleSwineHerderModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition strapback_r1 = carrotBag.addOrReplaceChild("strapback_r1",
        ...
        PartDefinition strapfrontb_r1 = carrotBag.addOrReplaceChild("strapfrontb_r1",
        ...
        PartDefinition strapfrontb_r2 = carrotBag.addOrReplaceChild("strapfrontb_r2",
        ...
        PartDefinition strapfronta_r1 = carrotBag.addOrReplaceChild("strapfronta_r1",
        ...
        PartDefinition bag_r1 = carrotBag.addOrReplaceChild("bag_r1",
            CubeListBuilder.create().texOffs(106, 38).addBox(-1.9F, -3.0F, -4.0F, 3.0F, 4.0F, 8.0F, new CubeDeformation(0.03F)),
            PartPose.offsetAndRotation(-5.5F, 12.0F, 0.0F, 0.0F, 0.0F, 0.1222F));

        PartDefinition carrot4 =
            carrotBag.addOrReplaceChild("carrot4",
                CubeListBuilder.create().texOffs(99, 59).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                    .texOffs(98, 50).addBox(0.0F, -2.9F, -1.5F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
                    .texOffs(98, 56).addBox(-1.5F, -2.9F, 0.0F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-6.0F, 7.6F, 2.9F, -0.2401F, -0.3826F, 0.063F));

        PartDefinition carrot3 =
            carrotBag.addOrReplaceChild("carrot3",
                CubeListBuilder.create().texOffs(105, 59).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                    .texOffs(104, 50).addBox(0.0F, -2.9F, -1.5F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
                    .texOffs(104, 56).addBox(-1.5F, -2.9F, 0.0F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-5.0F, 7.6F, 3.4F, -0.3011F, 0.0522F, 0.1666F));

        PartDefinition carrot2 =
            carrotBag.addOrReplaceChild("carrot2",
                CubeListBuilder.create().texOffs(111, 59).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                    .texOffs(110, 50).addBox(0.0F, -2.9F, -1.5F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
                    .texOffs(110, 56).addBox(-1.5F, -2.9F, 0.0F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-6.3F, 7.6F, -2.7F, 0.2608F, 0.0226F, -0.3897F));

        PartDefinition carrot1 =
            carrotBag.addOrReplaceChild("carrot1", CubeListBuilder.create().texOffs(117, 59).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
