...
public class MaleMinerModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition backpack =
            Body.addOrReplaceChild("backpack", CubeListBuilder.create().texOffs(104, 52).addBox(-4.0F, -2.7F, 0.0F, 8.0F, 8.0F, 4.0F, new CubeDeformation(0.3F))
        ...
        PartDefinition lid_r1 = backpack.addOrReplaceChild("lid_r1",
            CubeListBuilder.create().texOffs(104, 46).addBox(-4.0F, -2.2F, -0.5F, 8.0F, 2.0F, 4.0F, new CubeDeformation(0.4F)),
            PartPose.offsetAndRotation(0.0F, -2.1F, 0.6F, 0.0436F, 0.0F, 0.0F));

        PartDefinition pick =
            backpack.addOrReplaceChild("pick",
                CubeListBuilder.create().texOffs(110, 32).addBox(-0.5F, -2.275F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(-0.1F))
                    ...
                    .texOffs(106, 34).addBox(-3.5F, -0.575F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(4.5F, -1.225F, 4.7F, 0.0532F, 0.613F, 0.1697F));

        PartDefinition shovel =
            backpack.addOrReplaceChild("shovel",
                CubeListBuilder.create().texOffs(124, 31).addBox(-0.5F, -4.825F, -0.495F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.1F))
                    ...
                    .texOffs(114, 29).addBox(-0.5F, 3.575F, -1.015F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-4.6F, -1.075F, 4.595F, 0.1165F, 0.5925F, 0.1288F));

        PartDefinition stones =
            backpack.addOrReplaceChild("stones", CubeListBuilder.create().texOffs(104, 15).addBox(-0.3F, -4.5F, 0.4F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.6F))
        ...
        PartDefinition stone5_r1 = stones.addOrReplaceChild("stone5_r1",
            CubeListBuilder.create().texOffs(116, 9).addBox(-1.8F, -1.5F, -1.6F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.7F)),
        ...
        PartDefinition stone3_r1 = stones.addOrReplaceChild("stone3_r1",
            CubeListBuilder.create().texOffs(116, 21).mirror().addBox(-1.5F, -1.5F, -1.3F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.4F)).mirror(false),
            PartPose.offsetAndRotation(-1.8F, -3.0F, 2.2F, 0.0F, 0.0F, -0.0873F));

        PartDefinition stone1_r1 = stones.addOrReplaceChild("stone1_r1",
            CubeListBuilder.create().texOffs(116, 15).addBox(-1.2F, -1.5F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.3F)),
        ...
        PartDefinition torch2_r1 = torches.addOrReplaceChild("torch2_r1",
            CubeListBuilder.create().texOffs(107, 39).addBox(-0.5F, -2.3F, 0.1F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.2F)),
            PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0436F, 0.0F, 0.0F));

        PartDefinition torch1_r1 = torches.addOrReplaceChild("torch1_r1",
            CubeListBuilder.create().texOffs(103, 39).addBox(-0.5F, -3.0F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.2F)),
