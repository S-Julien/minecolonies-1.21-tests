...
public class FemaleSmelterModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition glasses =
            bipedHead.addOrReplaceChild("glasses", CubeListBuilder.create().texOffs(105, 10).addBox(-4.0F, -4.0F, -4.01F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.05F))
        ...
        PartDefinition crystalLeft =
            glasses.addOrReplaceChild("crystalLeft", CubeListBuilder.create().texOffs(118, 6).addBox(-3.0F, -6.0F, -4.8F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.2F))
        ...
        PartDefinition crystalRight =
            glasses.addOrReplaceChild("crystalRight", CubeListBuilder.create().texOffs(98, 6).addBox(-3.0F, -6.0F, -4.8F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.2F))
