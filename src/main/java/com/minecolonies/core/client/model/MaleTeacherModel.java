...
public class MaleTeacherModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition glasses =
            bipedHead.addOrReplaceChild("glasses", CubeListBuilder.create().texOffs(64, 0).addBox(-5.5F, -3.6F, -1.3F, 7.0F, 7.0F, 1.0F, new CubeDeformation(-2.0F))
        ...
        PartDefinition map_r1 = bag.addOrReplaceChild("map_r1",
            CubeListBuilder.create().texOffs(59, 23).addBox(-2.8F, -3.2F, -6.5F, 6.0F, 6.0F, 13.0F, new CubeDeformation(-2.0F)),
        ...
        PartDefinition strapback_r1 = bag.addOrReplaceChild("strapback_r1",
            CubeListBuilder.create().texOffs(92, 49).addBox(-0.5F, -14.3F, 0.0F, 1.0F, 15.0F, 0.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition strapfrontb_r1 = bag.addOrReplaceChild("strapfrontb_r1",
            CubeListBuilder.create().texOffs(93, 49).addBox(-0.5F, -1.8F, 0.3F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition strapfrontb_r2 = bag.addOrReplaceChild("strapfrontb_r2",
            CubeListBuilder.create().texOffs(93, 54).addBox(-0.5F, -2.5F, 0.5F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition strapfronta_r1 = bag.addOrReplaceChild("strapfronta_r1",
            CubeListBuilder.create().texOffs(96, 49).addBox(-0.5F, -8.0F, 0.0F, 1.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-5.5F, 9.4F, -4.1F, -0.0873F, 0.0F, 0.7854F));

        PartDefinition bag_r1 = bag.addOrReplaceChild("bag_r1",
            CubeListBuilder.create().texOffs(64, 50).addBox(-1.9F, -3.0F, -4.0F, 3.0F, 6.0F, 8.0F, new CubeDeformation(0.03F)),
        ...
        PartDefinition ruler_r1 = ruler.addOrReplaceChild("ruler_r1",
            CubeListBuilder.create().texOffs(86, 54).addBox(-0.5F, -4.0F, -1.3F, 1.0F, 8.0F, 2.0F, new CubeDeformation(-0.3F)),
