...
public class MaleCourierModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition bipedHead =
            partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -7.0F, -3.6148F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition shortBeard =
            bipedHead.addOrReplaceChild("shortBeard", CubeListBuilder.create().texOffs(24, 0).addBox(-3.5F, -23.1F, -5.9F, 7.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition backpack = bipedBody.addOrReplaceChild("backpack",
            ...
            PartPose.offset(0.0F, -7.4F, 2.3F));
        ...
        PartDefinition bipedRightArm =
            partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 16).addBox(-3.0F, -1.5F, -2.3F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition bipedLeftArm =
            partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(32, 48).addBox(-1.0F, -1.5F, -2.3F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
