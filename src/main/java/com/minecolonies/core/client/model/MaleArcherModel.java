...
public class MaleArcherModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition SailorHat1 =
            bipedHead.addOrReplaceChild("SailorHat1",
                CubeListBuilder.create().texOffs(102, 0).addBox(-4.0F, 1.33F, -5.318F, 8.0F, 0.0F, 10.0F, new CubeDeformation(0.0F))
                ...
                PartPose.offsetAndRotation(0.0F, -7.45F, -0.182F, -3.0369F, 0.0F, 3.1416F));

        PartDefinition feather2_r1 = SailorHat1.addOrReplaceChild("feather2_r1",
            CubeListBuilder.create().texOffs(110, 48).addBox(0.0F, -6.7F, -1.6F, 0.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(2.9F, -1.1903F, -2.1987F, -2.891F, 0.51F, -3.0173F));

        PartDefinition feather1_r1 = SailorHat1.addOrReplaceChild("feather1_r1",
            CubeListBuilder.create().texOffs(106, 44).addBox(-2.1F, -0.5F, -3.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(3.5F, -2.2F, -4.0F, 0.0F, 3.1416F, 0.0F));
        ...
        PartDefinition flap_r1 =
            SailorHat1.addOrReplaceChild("flap_r1",
                CubeListBuilder.create().texOffs(112, 40).addBox(0.0F, -4.0F, -5.0F, 8.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                    .texOffs(101, 21).addBox(0.0F, -0.1F, -5.0F, 8.0F, 0.0F, 11.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition flap_r3 =
            SailorHat1.addOrReplaceChild("flap_r3",
                CubeListBuilder.create().texOffs(112, 36).addBox(-7.0F, -4.0F, -5.0F, 8.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                    .texOffs(101, 10).addBox(-7.0F, -0.101F, -5.0F, 8.0F, 0.0F, 11.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition quiver =
            bipedBody.addOrReplaceChild("quiver", CubeListBuilder.create().texOffs(84, 18).addBox(-0.979F, -4.9528F, -1.25F, 3.0F, 14.0F, 0.0F, new CubeDeformation(0.05F))
