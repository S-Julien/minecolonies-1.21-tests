...
public class FemaleFloristModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition flower3_r1 = flowers.addOrReplaceChild("flower3_r1",
            CubeListBuilder.create().texOffs(74, 6).addBox(0.0F, -1.5F, -1.5F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.1F)),
            PartPose.offsetAndRotation(-0.1606F, 0.1409F, 2.8047F, 0.0355F, 0.014F, 0.1216F));

        PartDefinition flower2_r1 = flowers.addOrReplaceChild("flower2_r1",
            CubeListBuilder.create().texOffs(74, 3).addBox(0.1F, -1.5F, -1.5F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition flower1_r1 = flowers.addOrReplaceChild("flower1_r1",
            CubeListBuilder.create().texOffs(74, 0).addBox(0.2F, -1.1F, -1.9F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
