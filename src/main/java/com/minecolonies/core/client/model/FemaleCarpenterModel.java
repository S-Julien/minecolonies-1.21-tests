...
public class FemaleCarpenterModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition feather_r1 = Head.addOrReplaceChild("feather_r1",
            CubeListBuilder.create().texOffs(56, 15).addBox(-2.3F, -2.0F, -8.6F, 0.0F, 6.0F, 9.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-4.0F, -10.5F, 4.5F, 0.0F, -0.2356F, 0.0F));
        ...
        PartDefinition ponyTailTip_r1 = Ponytail.addOrReplaceChild("ponyTailTip_r1",
            CubeListBuilder.create().texOffs(88, 55).addBox(0.0F, 0.0F, 0.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.1F)),
        ...
        PartDefinition ponytailBase_r1 = Ponytail.addOrReplaceChild("ponytailBase_r1",
            CubeListBuilder.create().texOffs(86, 48).addBox(0.0F, 0.0F, 0.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition hair1 = Braid.addOrReplaceChild("hair1",
            CubeListBuilder.create().texOffs(104, 1).addBox(-0.1F, -1.0F, 5.1F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 1.9333F, 0.0F));

        PartDefinition hair2 = Braid.addOrReplaceChild("hair2",
            CubeListBuilder.create().texOffs(108, 0).addBox(-1.1F, -2.0F, 5.1F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 1.9333F, 0.0F));

        PartDefinition hair3 = Braid.addOrReplaceChild("hair3",
            CubeListBuilder.create().texOffs(106, 2).addBox(-1.0F, -2.0F, 4.8F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 1.3384F, 0.0F));

        PartDefinition hair4 = Braid.addOrReplaceChild("hair4",
            CubeListBuilder.create().texOffs(116, 0).addBox(0.5F, -2.5F, 3.35F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition apronBody =
            Body.addOrReplaceChild("apronBody", CubeListBuilder.create().texOffs(114, 11).addBox(-4.4F, -13.9F, -2.9F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.15F))
        ...
        PartDefinition arponTool =
            apronBody.addOrReplaceChild("arponTool",
                CubeListBuilder.create().texOffs(110, 46).addBox(-0.5F, -1.45F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(-0.2F))
                    ...
                    .texOffs(114, 47).addBox(-1.2F, -1.05F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)),
                PartPose.offsetAndRotation(2.1F, -15.75F, -3.1F, 0.0F, 0.0F, 0.2182F));
        ...
        PartDefinition strapfrontb_r2 = bag.addOrReplaceChild("strapfrontb_r2",
        ...
        PartDefinition ruler_r1 = ruler.addOrReplaceChild("ruler_r1",
            CubeListBuilder.create().texOffs(116, 54).addBox(-0.5F, -4.0F, -1.3F, 1.0F, 8.0F, 2.0F, new CubeDeformation(-0.3F)),
            PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1732F, -0.0806F, -0.0335F));

        PartDefinition saw = bag.addOrReplaceChild("saw",
            CubeListBuilder.create().texOffs(97, 54).addBox(-0.5F, -4.4F, 0.35F, 1.0F, 9.0F, 1.0F, new CubeDeformation(-0.2F))
                .texOffs(101, 48).addBox(-1.0F, -5.6F, -3.35F, 2.0F, 11.0F, 5.0F, new CubeDeformation(-1.0F)),
            PartPose.offsetAndRotation(-4.9511F, 7.0214F, -2.0706F, -0.8756F, -0.0226F, -3.0467F));
        ...
        PartDefinition apronRightLeg = Right_Leg.addOrReplaceChild("apronRightLeg",
            CubeListBuilder.create().texOffs(114, 19).addBox(-4.25F, -11.5F, -2.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.25F)),
        ...
        PartDefinition apronLeftLeg = Left_Leg.addOrReplaceChild("apronLeftLeg",
            CubeListBuilder.create().texOffs(106, 19).addBox(0.25F, -11.5F, -2.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.25F)),
            PartPose.offset(-1.9F, 12.0F, 0.0F));
