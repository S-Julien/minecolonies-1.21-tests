    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition FancyHat =
            bipedHead.addOrReplaceChild("FancyHat",
                CubeListBuilder.create().texOffs(96, 0).addBox(-4.1F, -1.9525F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.6F))
        ...
        PartDefinition feather2_r1 = FancyHat.addOrReplaceChild("feather2_r1",
            CubeListBuilder.create().texOffs(88, 21).addBox(-0.7F, -5.9F, -0.8F, 0.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)),
