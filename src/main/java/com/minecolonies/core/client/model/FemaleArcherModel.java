...
public class FemaleArcherModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition quiver =
            bipedBody.addOrReplaceChild("quiver", CubeListBuilder.create().texOffs(71, 20).addBox(-0.979F, -4.9528F, -1.25F, 3.0F, 14.0F, 0.0F, new CubeDeformation(0.05F))
