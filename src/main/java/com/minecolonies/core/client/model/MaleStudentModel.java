...
public class MaleStudentModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition glasses =
            Head.addOrReplaceChild("glasses", CubeListBuilder.create().texOffs(103, 0).addBox(-5.5F, -3.6F, -1.3F, 7.0F, 7.0F, 1.0F, new CubeDeformation(-2.0F))
        ...
        PartDefinition Belly =
            Body.addOrReplaceChild("Belly", CubeListBuilder.create().texOffs(56, 38).mirror().addBox(0.0F, 0.0F, 1.0F, 6.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition book = Right_Arm.addOrReplaceChild("book",
            CubeListBuilder.create().texOffs(64, 37).mirror().addBox(-7.3F, -14.5F, -3.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
        ...
        PartDefinition rightShoulder =
            Right_Arm_Folded.addOrReplaceChild("rightShoulder", CubeListBuilder.create().texOffs(56, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition rightForeArm =
            Right_Arm_Folded.addOrReplaceChild("rightForeArm", CubeListBuilder.create().texOffs(88, 16).addBox(-2.01F, -0.6F, -2.3F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition leftShoulder = Left_Arm_Folded.addOrReplaceChild("leftShoulder",
        ...
        PartDefinition leftForeArm = Left_Arm_Folded.addOrReplaceChild("leftForeArm",
