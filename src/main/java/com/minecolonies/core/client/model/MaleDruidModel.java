...
public class MaleDruidModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition righthorn_r1 = Horns.addOrReplaceChild("righthorn_r1",
            CubeListBuilder.create().texOffs(82, 41).addBox(-0.6F, -7.0F, 0.0F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(4.5F, -6.0F, -3.0F, 0.0F, 0.48F, 0.0F));

        PartDefinition lefthorn_r1 = Horns.addOrReplaceChild("lefthorn_r1",
            CubeListBuilder.create().texOffs(82, 27).addBox(0.6F, -7.0F, 0.0F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-4.5F, -6.0F, -3.0F, 0.0F, -0.48F, 0.0F));
        ...
        PartDefinition Potion1 =
            potionBag.addOrReplaceChild("Potion1",
                CubeListBuilder.create().texOffs(96, 7).addBox(-2.3152F, -2.1035F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(-1.1F))
                    ...
                    .texOffs(97, 18).addBox(-2.3152F, -0.4535F, -2.5F, 5.0F, 3.0F, 5.0F, new CubeDeformation(-1.0F)),
                PartPose.offsetAndRotation(2.1F, -21.42F, -4.2F, 0.0F, 0.0F, -0.6196F));

        PartDefinition Potion2 =
            potionBag.addOrReplaceChild("Potion2",
                CubeListBuilder.create().texOffs(96, 26).addBox(-2.5F, -2.18F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(-1.1F))
                    ...
                    .texOffs(97, 37).addBox(-2.5F, -0.53F, -2.5F, 5.0F, 3.0F, 5.0F, new CubeDeformation(-1.0F)),
                PartPose.offsetAndRotation(-0.667F, -18.8666F, -4.2F, 0.0F, 0.0F, -0.6196F));

        PartDefinition Potion3 =
            potionBag.addOrReplaceChild("Potion3",
                CubeListBuilder.create().texOffs(96, 45).addBox(-2.4653F, -2.4009F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(-1.1F))
                    ...
                    .texOffs(97, 56).addBox(-2.4653F, -0.7509F, -2.5F, 5.0F, 3.0F, 5.0F, new CubeDeformation(-1.0F)),
                PartPose.offsetAndRotation(-3.3233F, -15.9508F, -4.2F, 0.0F, 0.0F, -0.6196F));

        PartDefinition mainStrap = potionBag.addOrReplaceChild("mainStrap", CubeListBuilder.create(), PartPose.offset(0.0F, -18.3F, -2.0F));

        PartDefinition mainStrap_r1 = mainStrap.addOrReplaceChild("mainStrap_r1",
            CubeListBuilder.create().texOffs(63, 13).addBox(-7.0F, -1.0F, -0.5F, 14.0F, 2.0F, 5.0F, new CubeDeformation(0.1F)),
            PartPose.offsetAndRotation(0.0F, 0.0F, -0.3F, 0.0F, 0.0F, -0.829F));

        PartDefinition symbol = potionBag.addOrReplaceChild("symbol", CubeListBuilder.create(), PartPose.offset(4.5F, -23.2F, -3.1F));

        PartDefinition symbol_r1 = symbol.addOrReplaceChild("symbol_r1",
            CubeListBuilder.create().texOffs(83, 20).addBox(-2.5F, -2.5F, -1.0F, 5.0F, 5.0F, 2.0F, new CubeDeformation(-1.4F)),
            PartPose.offsetAndRotation(0.0F, 0.0F, 0.2F, 0.0F, 0.0F, 0.7854F));
