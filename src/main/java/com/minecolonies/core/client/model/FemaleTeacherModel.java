...
public class FemaleTeacherModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition feather_r1 = bipedHead.addOrReplaceChild("feather_r1",
            CubeListBuilder.create().texOffs(56, 16).addBox(-2.3F, -1.9F, -8.6F, 0.0F, 5.0F, 9.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition dress =
            bipedBody.addOrReplaceChild("dress", CubeListBuilder.create().texOffs(90, 14).addBox(-5.0F, -11.0F, -4.0F, 10.0F, 9.0F, 9.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition bipedRightArm =
            partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 16).addBox(-1.4F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
