...
public class FemaleFarmerModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition strapLeft_r1 = seedBox.addOrReplaceChild("strapLeft_r1",
            CubeListBuilder.create().texOffs(54, 37).mirror().addBox(0.1F, -0.5F, -4.0F, 0.0F, 1.0F, 8.0F, new CubeDeformation(0.11F)).mirror(false)
                .texOffs(70, 37).mirror().addBox(-8.1F, -0.5F, -4.0F, 0.0F, 1.0F, 8.0F, new CubeDeformation(0.11F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.9599F, 0.0F, 0.0F));

        PartDefinition seeds_r1 = seedBox.addOrReplaceChild("seeds_r1",
            CubeListBuilder.create().texOffs(62, 33).mirror().addBox(-3.0F, -1.25F, -1.6667F, 6.0F, 1.0F, 3.0F, new CubeDeformation(-0.1F)).mirror(false)
                ...
                .texOffs(61, 18).mirror().addBox(-3.0F, 0.45F, -1.6667F, 6.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(-4.0F, 4.05F, -0.3333F, -0.1309F, 0.0F, 0.0F));
