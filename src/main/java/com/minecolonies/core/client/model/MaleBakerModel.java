...
public class MaleBakerModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition hat = bipedHead.addOrReplaceChild("hat",
            CubeListBuilder.create().texOffs(92, 36).mirror().addBox(-4.5F, -1.0F, -4.5F, 9.0F, 2.0F, 9.0F, new CubeDeformation(0.1F)).mirror(false)
                .texOffs(98, 47).mirror().addBox(-3.5F, -2.0F, -3.7F, 7.0F, 1.0F, 8.0F, new CubeDeformation(0.1F)).mirror(false)
                .texOffs(104, 56).mirror().addBox(-2.5F, -3.0F, -3.3F, 5.0F, 1.0F, 7.0F, new CubeDeformation(0.1F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, -7.8F, 0.0F, -0.0873F, 0.0F, 0.0F));
        ...
        PartDefinition top_r1 = BakerHat.addOrReplaceChild("top_r1",
            CubeListBuilder.create().texOffs(86, 12).mirror().addBox(-6.4F, -1.1F, -6.2F, 11.0F, 2.0F, 10.0F, new CubeDeformation(0.1F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, -1.9564F, -1.8335F, 0.6076F, 0.0469F, -0.1477F));

        PartDefinition middle_r1 = BakerHat.addOrReplaceChild("middle_r1",
            CubeListBuilder.create().texOffs(94, 24).mirror().addBox(-4.48F, -1.8F, -4.7F, 9.0F, 4.0F, 8.0F, new CubeDeformation(-0.1F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, -0.8021F, -1.7031F, 0.5659F, 0.0334F, -0.0807F));

        PartDefinition base_r1 = BakerHat.addOrReplaceChild("base_r1",
            CubeListBuilder.create().texOffs(88, 0).mirror().addBox(-5.0F, -1.1F, -5.4F, 10.0F, 2.0F, 10.0F, new CubeDeformation(-0.2F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, 1.5F, -1.0F, 0.48F, 0.0F, 0.0F));
        ...
        PartDefinition apronBody =
            bipedBody.addOrReplaceChild("apronBody", CubeListBuilder.create().texOffs(78, 47).addBox(-4.4F, -13.9F, -2.9F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.15F))
        ...
        PartDefinition apronRightLeg = bipedRightLeg.addOrReplaceChild("apronRightLeg",
            CubeListBuilder.create().texOffs(78, 56).addBox(-4.25F, -11.5F, -2.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.25F)),
        ...
        PartDefinition apronLeftLeg = bipedLeftLeg.addOrReplaceChild("apronLeftLeg",
            CubeListBuilder.create().texOffs(70, 56).addBox(0.25F, -11.5F, -2.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.25F)),
            PartPose.offset(-1.9F, 12.0F, 0.0F));
