...
public class MaleCowHerderModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition straw_r1 = straw.addOrReplaceChild("straw_r1",
            CubeListBuilder.create().texOffs(92, 30).addBox(-2.4F, -1.9375F, -6.1F, 4.0F, 7.0F, 8.0F, new CubeDeformation(-2.0F)),
        ...
        PartDefinition bucketwithHandle =
            bipedRightLeg.addOrReplaceChild("bucketwithHandle", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.1F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.1309F));
        ...
        PartDefinition handle_r1 = bucketwithHandle.addOrReplaceChild("handle_r1",
            ...
            PartPose.offsetAndRotation(0.0F, 3.5F, -3.2F, -0.4363F, 0.0F, 0.0F));

        PartDefinition bucket =
            bucketwithHandle.addOrReplaceChild("bucket",
                CubeListBuilder.create().texOffs(112, 42).addBox(-2.0F, -0.5248F, -1.7164F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.15F))
                    .texOffs(112, 47).addBox(-2.0F, -0.5248F, -1.7164F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                    .texOffs(116, 55).addBox(-1.5F, 2.8752F, -1.2164F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.2F)),
                PartPose.offsetAndRotation(0.0F, 3.3F, -3.5F, 0.1745F, 0.0F, 0.0F));
