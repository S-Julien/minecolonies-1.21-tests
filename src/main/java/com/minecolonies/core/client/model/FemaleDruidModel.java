...
public class FemaleDruidModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition righthorn_r1 = Horns.addOrReplaceChild("righthorn_r1",
            CubeListBuilder.create().texOffs(80, 24).addBox(-0.6F, -7.0F, 0.0F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(4.5F, -6.0F, -3.0F, 0.0F, 0.48F, 0.0F));

        PartDefinition lefthorn_r1 = Horns.addOrReplaceChild("lefthorn_r1",
            CubeListBuilder.create().texOffs(80, 10).addBox(0.6F, -7.0F, 0.0F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-4.5F, -6.0F, -3.0F, 0.0F, -0.48F, 0.0F));
        ...
        PartDefinition Potion1 =
            potions.addOrReplaceChild("Potion1", CubeListBuilder.create().texOffs(96, 7).addBox(-1.9152F, 1.4965F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(-1.4F))
        ...
        PartDefinition Potion2 =
            potions.addOrReplaceChild("Potion2", CubeListBuilder.create().texOffs(97, 26).addBox(-2.1F, 2.42F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(-1.4F))
        ...
        PartDefinition Potion3 =
            potions.addOrReplaceChild("Potion3", CubeListBuilder.create().texOffs(96, 45).addBox(-2.4653F, -0.8009F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(-1.4F))
        ...
        PartDefinition satchet =
            potionSatchet.addOrReplaceChild("satchet", CubeListBuilder.create().texOffs(60, 12).addBox(-4.5F, 0.8F, -2.2F, 9.0F, 1.0F, 4.0F, new CubeDeformation(-0.3F))
        ...
        PartDefinition locket_r1 = lid.addOrReplaceChild("locket_r1",
            CubeListBuilder.create().texOffs(66, 18).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.4F)),
            PartPose.offsetAndRotation(0.0F, -5.2F, -0.6F, -0.3142F, 0.0F, 0.0F));

        PartDefinition lid_r1 = lid.addOrReplaceChild("lid_r1",
            CubeListBuilder.create().texOffs(59, 34).addBox(-4.5F, -2.5F, -0.5F, 9.0F, 3.0F, 1.0F, new CubeDeformation(-0.311F)),
            PartPose.offsetAndRotation(0.0F, -4.5F, 1.4F, 1.0472F, 0.0F, 0.0F));

        PartDefinition straps = potionSatchet.addOrReplaceChild("straps", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition rightStrap_r1 = straps.addOrReplaceChild("rightStrap_r1",
            CubeListBuilder.create().texOffs(58, 16).addBox(0.0F, -9.0F, -0.5F, 0.0F, 10.0F, 1.0F, new CubeDeformation(-0.1F)),
            PartPose.offsetAndRotation(-4.3F, -14.7F, -4.1F, -0.2094F, 0.0F, 0.0F));

        PartDefinition leftStrap_r1 = straps.addOrReplaceChild("leftStrap_r1",
            CubeListBuilder.create().texOffs(56, 16).addBox(0.0F, -9.0F, -0.5F, 0.0F, 10.0F, 1.0F, new CubeDeformation(-0.1F)),
            PartPose.offsetAndRotation(4.3F, -14.7F, -4.1F, -0.2007F, 0.0F, 0.0F));
