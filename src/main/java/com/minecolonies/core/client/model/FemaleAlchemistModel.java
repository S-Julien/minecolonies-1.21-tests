...
public class FemaleAlchemistModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition top4_r1 = PointHat.addOrReplaceChild("top4_r1",
            CubeListBuilder.create().texOffs(84, 0).addBox(-0.3F, -9.5F, -2.4F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 0.1F, -0.4F, -0.5638F, -0.2158F, -0.1694F));

        PartDefinition top3_r1 = PointHat.addOrReplaceChild("top3_r1",
            CubeListBuilder.create().texOffs(88, 1).addBox(-2.5F, -7.5F, -1.8F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 0.1F, -0.4F, -0.3051F, -0.0885F, 0.0096F));

        PartDefinition top2_r1 = PointHat.addOrReplaceChild("top2_r1",
            CubeListBuilder.create().texOffs(58, 9).addBox(-3.5F, -4.9F, -3.8F, 7.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 0.1F, 0.0F, -0.1752F, -0.0859F, 0.0152F));
        ...
        PartDefinition IngredientPouch = Body.addOrReplaceChild("IngredientPouch",
            ...
            PartPose.offsetAndRotation(-2.0667F, 10.3417F, -2.65F, 0.0F, 0.0F, 0.0436F));

        PartDefinition top_r1 = IngredientPouch.addOrReplaceChild("top_r1",
            CubeListBuilder.create().texOffs(81, 31).addBox(-0.5F, -2.65F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(-0.1F)),
            PartPose.offsetAndRotation(-0.1333F, 1.3583F, 0.15F, 0.0F, -0.2618F, 0.0F));
        ...
        PartDefinition capeShoulderRight = Right_Arm.addOrReplaceChild("capeShoulderRight",
            CubeListBuilder.create().texOffs(112, 29).addBox(-1.0F, -1.0F, -2.5F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.2F)),
