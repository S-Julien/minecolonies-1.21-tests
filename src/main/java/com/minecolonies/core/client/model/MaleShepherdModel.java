...
public class MaleShepherdModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition straw_r1 = straw.addOrReplaceChild("straw_r1",
            CubeListBuilder.create().texOffs(102, 30).addBox(-2.4F, -1.9375F, -6.1F, 4.0F, 7.0F, 8.0F, new CubeDeformation(-2.0F)),
            PartPose.offsetAndRotation(1.0F, 4.4375F, -3.4F, -0.3927F, -0.4363F, 0.0F));
        ...
        PartDefinition center = Cap.addOrReplaceChild("center",
            CubeListBuilder.create().texOffs(64, 0).addBox(-4.0F, 0.5F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.51F)),
            PartPose.offset(0.0F, -1.0F, 0.0F));

        PartDefinition tip = Cap.addOrReplaceChild("tip",
            CubeListBuilder.create().texOffs(88, 0).addBox(-0.5F, 3.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.4F)),
            PartPose.offsetAndRotation(0.0F, -4.2F, 0.0F, 0.0F, -0.7418F, 0.0F));

        PartDefinition sideFront = Cap.addOrReplaceChild("sideFront",
            CubeListBuilder.create().texOffs(92, 0).addBox(-4.0F, -0.3454F, -4.0685F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.5F)),
            PartPose.offsetAndRotation(0.0F, -0.6F, -0.5F, 0.1745F, 0.0F, 0.0F));

        PartDefinition sideLeft = Cap.addOrReplaceChild("sideLeft",
            CubeListBuilder.create().texOffs(110, 0).addBox(-3.5F, -0.3975F, -4.364F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.5F)),
            PartPose.offsetAndRotation(0.0F, -0.6F, -0.5F, 0.1745F, -1.5708F, 0.0F));

        PartDefinition sideRight = Cap.addOrReplaceChild("sideRight",
            CubeListBuilder.create().texOffs(92, 2).addBox(-3.5F, -0.3801F, -4.2655F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.5F)),
            PartPose.offsetAndRotation(0.0F, -0.6F, 0.5F, 0.1745F, 1.5708F, 0.0F));

        PartDefinition sideBack = Cap.addOrReplaceChild("sideBack",
            CubeListBuilder.create().texOffs(110, 2).addBox(-4.0F, -0.2933F, -3.7731F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.5F)),
            PartPose.offsetAndRotation(0.0F, -0.6F, 0.5F, 0.1745F, 3.1416F, 0.0F));

        PartDefinition visor = Cap.addOrReplaceChild("visor",
            CubeListBuilder.create().texOffs(88, 4).addBox(-4.0F, -0.5F, -1.5F, 8.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition staff_r1 = FoldedRightArm.addOrReplaceChild("staff_r1",
            CubeListBuilder.create().texOffs(88, 19).addBox(-0.5F, -13.0F, -0.5F, 1.0F, 32.0F, 1.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-0.5F, 3.0F, -3.5F, 0.0436F, 0.0F, 0.0F));

        PartDefinition shoulderArm =
            FoldedRightArm.addOrReplaceChild("shoulderArm", CubeListBuilder.create().texOffs(56, 16).addBox(-3.01F, -2.01F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition foreArm =
            FoldedRightArm.addOrReplaceChild("foreArm", CubeListBuilder.create().texOffs(72, 16).addBox(-2.01F, -1.5F, -2.5F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.01F))
