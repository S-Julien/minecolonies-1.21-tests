...
public class MaleNetherWorkerModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition backpack =
            Body.addOrReplaceChild("backpack", CubeListBuilder.create().texOffs(100, 48).addBox(-4.0F, -2.7F, 0.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.3F))
        ...
        PartDefinition roll_r1 = backpack.addOrReplaceChild("roll_r1",
            CubeListBuilder.create().texOffs(102, 24).addBox(-5.0F, -1.0F, -2.1F, 10.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, -6.4F, 3.2F, 0.5585F, 0.0F, 0.0F));

        PartDefinition lid_r1 = backpack.addOrReplaceChild("lid_r1",
            CubeListBuilder.create().texOffs(100, 40).addBox(-4.0F, -2.2F, -0.5F, 8.0F, 2.0F, 6.0F, new CubeDeformation(0.4F)),
            PartPose.offsetAndRotation(0.0F, -2.1F, 0.6F, 0.0436F, 0.0F, 0.0F));

        PartDefinition pick =
            backpack.addOrReplaceChild("pick",
                CubeListBuilder.create().texOffs(110, 16).addBox(-1.1F, -2.275F, 1.0F, 1.0F, 7.0F, 1.0F, new CubeDeformation(-0.1F))
                    ...
                    .texOffs(106, 18).addBox(-4.1F, -0.575F, 1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(4.5F, -2.125F, 4.7F, 0.0532F, 0.613F, 0.1697F));

        PartDefinition shovel =
            backpack.addOrReplaceChild("shovel",
                CubeListBuilder.create().texOffs(124, 17).addBox(-0.5F, -4.825F, -0.495F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.1F))
                    ...
                    .texOffs(114, 15).addBox(-0.5F, 3.575F, -1.015F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-5.1F, -1.875F, 6.095F, 0.1165F, 0.5925F, 0.1288F));
        ...
        PartDefinition torch2_r1 = torches.addOrReplaceChild("torch2_r1",
            CubeListBuilder.create().texOffs(100, 33).addBox(-0.5F, -2.3F, 0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.1F)),
            PartPose.offsetAndRotation(0.0F, -0.3628F, -0.2844F, -0.0436F, 0.0F, 0.0F));

        PartDefinition torch1_r1 = torches.addOrReplaceChild("torch1_r1",
            CubeListBuilder.create().texOffs(96, 33).addBox(-0.5F, -3.0F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.1F)),
            PartPose.offsetAndRotation(0.0F, -0.3628F, -0.2844F, 0.0873F, 0.0F, 0.0F));

        PartDefinition stones =
            backpack.addOrReplaceChild("stones", CubeListBuilder.create().texOffs(78, 18).addBox(-0.3F, -4.5F, 0.4F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.6F))
        ...
        PartDefinition stone5_r1 = stones.addOrReplaceChild("stone5_r1",
            CubeListBuilder.create().texOffs(90, 12).addBox(-1.8F, -1.5F, -1.6F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.7F)),
            PartPose.offsetAndRotation(-2.6F, -3.0F, 1.5F, 0.0866F, 0.0106F, -0.1217F));

        PartDefinition stone3_r1 = stones.addOrReplaceChild("stone3_r1",
            CubeListBuilder.create().texOffs(90, 24).mirror().addBox(-1.5F, -1.5F, -1.3F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.4F)).mirror(false),
            PartPose.offsetAndRotation(-1.8F, -3.0F, 2.2F, 0.0F, 0.0F, -0.0873F));

        PartDefinition stone1_r1 = stones.addOrReplaceChild("stone1_r1",
            CubeListBuilder.create().texOffs(90, 18).addBox(-1.2F, -1.5F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.3F)),
            PartPose.offsetAndRotation(2.2F, -2.8F, 2.2F, 0.0F, 0.0F, 0.1309F));
