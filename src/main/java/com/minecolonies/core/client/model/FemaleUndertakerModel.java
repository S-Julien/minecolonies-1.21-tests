...
public class FemaleUndertakerModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition TopHat =
            bipedHead.addOrReplaceChild("TopHat", CubeListBuilder.create().texOffs(72, 0).addBox(-3.9664F, -3.1854F, -5.0F, 8.0F, 2.0F, 10.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition hatpartlowleft = TopHat.addOrReplaceChild("hatpartlowleft",
            CubeListBuilder.create().texOffs(100, 7).addBox(-2.3F, -0.7F, -5.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.01F)),
            PartPose.offsetAndRotation(-3.1F, -2.2F, 0.0F, 0.0F, 0.0F, 0.48F));

        PartDefinition hatpartlowright = TopHat.addOrReplaceChild("hatpartlowright",
            CubeListBuilder.create().texOffs(104, 19).addBox(0.4466F, 1.4993F, -5.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.01F)),
