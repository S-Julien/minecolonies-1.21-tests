...
public class FemaleFisherModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition hair1 = Braid.addOrReplaceChild("hair1",
            CubeListBuilder.create().texOffs(74, 1).mirror().addBox(-0.1F, -1.0F, 5.1F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 1.9333F, 0.0F));

        PartDefinition hair2 = Braid.addOrReplaceChild("hair2",
            CubeListBuilder.create().texOffs(78, 0).mirror().addBox(-1.1F, -2.0F, 5.1F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 1.9333F, 0.0F));

        PartDefinition hair3 = Braid.addOrReplaceChild("hair3",
            CubeListBuilder.create().texOffs(76, 2).mirror().addBox(-1.0F, -2.0F, 4.8F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 1.3384F, 0.0F));

        PartDefinition hair4 = Braid.addOrReplaceChild("hair4",
            CubeListBuilder.create().texOffs(86, 0).mirror().addBox(0.5F, -2.5F, 3.35F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 0.4833F, 0.0F));

        PartDefinition FishermanCap = bipedHead.addOrReplaceChild("FishermanCap",
            CubeListBuilder.create().texOffs(88, 0).mirror().addBox(-5.0F, -2.1F, -5.0F, 10.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, -0.1222F, 0.0F, 0.0F));

        PartDefinition detail1_r1 = FishermanCap.addOrReplaceChild("detail1_r1",
            CubeListBuilder.create().texOffs(118, 5).addBox(-1.6F, -1.6F, 0.3F, 4.0F, 4.0F, 1.0F, new CubeDeformation(-0.5F)),
            PartPose.offsetAndRotation(5.0F, -2.9F, -5.6F, -0.5847F, -0.6981F, 0.0F));

        PartDefinition middle_r1 = FishermanCap.addOrReplaceChild("middle_r1",
            CubeListBuilder.create().texOffs(96, 15).mirror().addBox(-4.0F, -1.4F, -3.2F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, -2.2F, 0.0F, -0.1047F, 0.0F, 0.0F));

        PartDefinition LeftLid_r1 = FishermanCap.addOrReplaceChild("LeftLid_r1",
            CubeListBuilder.create().texOffs(66, 5).mirror().addBox(-1.6F, -0.9F, -5.0F, 2.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(-5.0F, -0.2F, 0.0F, 0.0F, 0.0F, -0.3491F));

        PartDefinition BackLid_r1 = FishermanCap.addOrReplaceChild("BackLid_r1",
            CubeListBuilder.create().texOffs(80, 12).mirror().addBox(-5.0F, -0.9F, -1.6F, 10.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, -0.2F, -5.0F, 0.3491F, 0.0F, 0.0F));

        PartDefinition RightLid_r1 = FishermanCap.addOrReplaceChild("RightLid_r1",
            CubeListBuilder.create().texOffs(82, 15).mirror().addBox(-0.4F, -0.9F, -5.0F, 2.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(5.0F, -0.2F, 0.0F, 0.0F, 0.0F, 0.3491F));

        PartDefinition FrontLid_r1 = FishermanCap.addOrReplaceChild("FrontLid_r1",
            CubeListBuilder.create().texOffs(104, 12).mirror().addBox(-5.0F, -0.9F, -0.4F, 10.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, -0.2F, 5.0F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition fishingPole = bipedBody.addOrReplaceChild("fishingPole",
            CubeListBuilder.create().texOffs(122, 25).mirror().addBox(-4.3F, -4.4F, 2.0F, 1.0F, 16.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(122, 42).mirror().addBox(-6.3F, 6.6F, 2.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(126, 26).mirror().addBox(-4.8F, -4.15F, 2.5F, 1.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.7436F));

        PartDefinition lures =
            bipedBody.addOrReplaceChild("lures", CubeListBuilder.create().texOffs(108, 25).addBox(-5.0F, 0.0F, -3.41F, 5.0F, 5.0F, 2.0F, new CubeDeformation(-1.0F))
        ...
        PartDefinition bipedLeftLeg = partdefinition.addOrReplaceChild("left_leg",
