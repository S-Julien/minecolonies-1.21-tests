...
public class BuildingModules
{
    ...
    public static final BuildingEntry.ModuleProducer<CraftingWorkerBuildingModule, WorkerBuildingModuleView>   CONCRETEMIXER_WORK  =
        new BuildingEntry.ModuleProducer<>("concretemixer_work",
            () -> new CraftingWorkerBuildingModule(ModJobs.concreteMixer.get(), Skill.Stamina, Skill.Dexterity, false, (b) -> 1),
            () -> WorkerBuildingModuleView::new);
    ...
    public static final BuildingEntry.ModuleProducer<CraftingWorkerBuildingModule, WorkerBuildingModuleView>  NETHERWORKER_WORK       =
        new BuildingEntry.ModuleProducer<>("netherworker_work",
            () -> new CraftingWorkerBuildingModule(ModJobs.netherworker.get(), Skill.Adaptability, Skill.Strength, false, (b) -> 1),
            () -> WorkerBuildingModuleView::new);
