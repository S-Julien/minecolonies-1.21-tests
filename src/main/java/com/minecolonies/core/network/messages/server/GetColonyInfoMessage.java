...
public class GetColonyInfoMessage implements IMessage
{
    ...
    public void onExecute(final NetworkEvent.Context ctxIn, final boolean isLogicalServer)
    {
        ...
        if (IColonyManager.getInstance().isFarEnoughFromColonies(world, pos))
        {
            ...
            {
                Network.getNetwork()
                    .sendToPlayer(new OpenCantFoundColonyWarningMessage(Component.translatable("com.minecolonies.core.founding.tooclosetospawn",
            ...
            {
                Network.getNetwork()
                    .sendToPlayer(new OpenCantFoundColonyWarningMessage(Component.translatable("com.minecolonies.core.founding.toofarfromspawn",
        ...
        else
        {
            ...
            Network.getNetwork()
                .sendToPlayer(new OpenCantFoundColonyWarningMessage(Component.translatable("com.minecolonies.core.founding.tooclosetocolony", Math.max(100, blockRange - distance)),
                    pos,
                    false), sender);
        }
    }
