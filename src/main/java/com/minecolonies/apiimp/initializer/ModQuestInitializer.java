...
public final class ModQuestInitializer
{
    ...
    static
    {
        ...
        QuestRegistries.questReputationTrigger = DEFERRED_REGISTER_TRIGGER.register(QUEST_REPUTATION_TRIGGER_ID.getPath(),
            () -> new QuestRegistries.TriggerEntry(QuestReputationTriggerTemplate::createQuestReputationTrigger));
        QuestRegistries.worldDifficultyTrigger = DEFERRED_REGISTER_TRIGGER.register(WORLD_DIFFICULTY_TRIGGER_ID.getPath(),
            () -> new QuestRegistries.TriggerEntry(WorldDifficultyTriggerTemplate::createDifficultyTrigger));
        ...
        QuestRegistries.happinessReward =
            DEFERRED_REGISTER_REWARD.register(HAPPINESS_REWARD_ID.getPath(), () -> new QuestRegistries.RewardEntry(HappinessRewardTemplate::createReward));
        ...
        QuestRegistries.questReputationReward =
            DEFERRED_REGISTER_REWARD.register(QUEST_REPUTATION_REWARD_ID.getPath(), () -> new QuestRegistries.RewardEntry(QuestReputationRewardTemplate::createReward));
