...
public final class ModBlocksInitializer
{
    ...
    public static void init(final IForgeRegistry<Block> registry)
    {
        ...
        ModBlocks.blockBellPepper =
            new MinecoloniesCropBlock(BELL_PEPPER, ModBlocks.farmland, List.of(Blocks.GRASS, Blocks.TALL_GRASS), ModTags.temperateBiomes).registerBlock(registry);
        ...
        ModBlocks.blockChickpea =
            new MinecoloniesCropBlock(CHICKPEA, ModBlocks.farmland, List.of(Blocks.GRASS, Blocks.TALL_GRASS, Blocks.DEAD_BUSH), ModTags.dryBiomes).registerBlock(registry);
        ...
        ModBlocks.blockSoyBean =
            new MinecoloniesCropBlock(SOYBEAN, ModBlocks.farmland, List.of(Blocks.GRASS, Blocks.TALL_GRASS, Blocks.FERN), ModTags.humidBiomes).registerBlock(registry);
        ...
        ModBlocks.blockRice =
            new MinecoloniesCropBlock(RICE, ModBlocks.floodedFarmland, List.of(Blocks.SEAGRASS, Blocks.SMALL_DRIPLEAF), ModTags.humidBiomes).registerBlock(registry);

        ModBlocks.blockButternutSquash =
            new MinecoloniesCropBlock(BUTTERNUT_SQUASH, ModBlocks.farmland, List.of(Blocks.GRASS, Blocks.TALL_GRASS), ModTags.coldBiomes).registerBlock(registry);
        ...
        ModBlocks.blockNetherPepper =
            new MinecoloniesCropBlock(NETHER_PEPPER, ModBlocks.farmland, List.of(Blocks.GRASS, Blocks.TALL_GRASS), ModTags.dryBiomes).registerBlock(registry);
